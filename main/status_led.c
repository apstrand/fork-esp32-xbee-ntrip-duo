...
#define STATUS_LED_RED_GPIO GPIO_NUM_1
#define STATUS_LED_GREEN_GPIO GPIO_NUM_2
#define STATUS_LED_BLUE_GPIO GPIO_NUM_3
#else
...
#if CONFIG_IDF_TARGET_ESP32S3
#define STATUS_LED_RSSI_GPIO GPIO_NUM_4
#define STATUS_LED_SLEEP_GPIO GPIO_NUM_5
#define STATUS_LED_ASSOC_GPIO GPIO_NUM_6
#else
