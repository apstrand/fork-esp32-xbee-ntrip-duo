...
//   CONFIG SIGNALGROUP 2  enable multi-frequency (L1/L2/L5) tracking — required for
//                         Onocoy MSM7 rewards; without this the receiver defaults to L1 only
...
//                         (1006 supersedes 1005 — includes antenna height, send only 1006)
//   RTCM1077 1            GPS MSM7 every 1 s      (MSM7 supersedes MSM4/MSM6)
//   RTCM1087 1            GLONASS MSM7 every 1 s
//   RTCM1097 1            Galileo MSM7 every 1 s
//   RTCM1127 1            BeiDou MSM7 every 1 s
//   RTCM1117 1            QZSS MSM7 every 1 s (harmless outside Asia-Pacific)
